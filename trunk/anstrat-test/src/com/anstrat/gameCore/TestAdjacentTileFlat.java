...
public class TestAdjacentTileFlat {
	...
	private void testAdjacent(Map map){
		assertTrue(map.getAdjacentOrientation(origin, new TileCoordinate(0, 1)) == Map.ADJACENT_NW);
		assertTrue(map.getAdjacentOrientation(origin, new TileCoordinate(1, 0)) == Map.ADJACENT_N);
		assertTrue(map.getAdjacentOrientation(origin, new TileCoordinate(2, 1)) == Map.ADJACENT_NE);
		assertTrue(map.getAdjacentOrientation(origin, new TileCoordinate(0, 2)) == Map.ADJACENT_SW);
		assertTrue(map.getAdjacentOrientation(origin, new TileCoordinate(1, 2)) == Map.ADJACENT_S);
	...
	private void testNonAdjacent(Map map){
		...
		assertTrue(map.getAdjacentOrientation(origin, new TileCoordinate(0, 3)) == Map.NOT_ADJACENT);
		assertTrue(map.getAdjacentOrientation(origin, new TileCoordinate(2, 3)) == Map.NOT_ADJACENT);
		assertTrue(map.getAdjacentOrientation(origin, new TileCoordinate(2, 0)) == Map.NOT_ADJACENT);
	}
