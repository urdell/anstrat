...
public class SnapScrollPane extends WidgetGroup {
	private SnapScrollPaneStyle style;
	...
	public SnapScrollPane (Actor widget) {
		this(widget, new SnapScrollPaneStyle());
	}
	...
	public void setStyle (SnapScrollPaneStyle style) {
		if (style == null) throw new IllegalArgumentException("style cannot be null.");
		this.style = style;
		invalidateHierarchy();
	}
	...
	public SnapScrollPaneStyle getStyle () {
		return style;
	}
	 ...
	 * @author mzechner
	 * @author Nathan Sweet */
	static public class SnapScrollPaneStyle {
		/** Optional. */
		...
		public SnapScrollPaneStyle () {
		}

		public SnapScrollPaneStyle (Drawable background, Drawable hScroll, Drawable hScrollKnob, Drawable vScroll, Drawable vScrollKnob) {
		...
		public SnapScrollPaneStyle (SnapScrollPaneStyle style) {
